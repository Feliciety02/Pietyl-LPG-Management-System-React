  ...
  export default function Thresholds() {
    ...
    const columns = useMemo(() => {
        ...
        },
      {
        key: "stock",
        label: "Stock",
        render: (row) => (loading ? <div className="h-4 w-32 rounded bg-slate-200 animate-pulse" /> : <StockMini current={row.qty_filled ?? row.current_qty} threshold={row.reorder_level} />),
      },
        {
          key: "threshold",
          label: "Alert level",
